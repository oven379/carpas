...
/** Общий текст справки для поля города (CityComboBox): без имён сервисов и настроек разработки. */
export const CITY_FIELD_DD_HINT =
  'Начните вводить название — появятся подсказки по городам России. Если нужного города нет в списке, наберите название полностью вручную.'
