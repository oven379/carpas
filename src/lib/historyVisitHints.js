...
export const FORM_SERVICES_VISIT_BLOCK_HINT = {
  ...
  textDetailing:
    'Здесь услуги из «Настроек лендинга» и разовые дополнительные услуги. Если нужной позиции нет, введите своё название в поиск и нажмите «Добавить».',
  textOwner:
...
export const FORM_COMMENT_HINT = {
  ...
  label: 'Справка: рекомендации мастера',
  text: 'Свободный текст дополняет услуги ниже: что делали, материалы, детали и рекомендации после визита. Владелец видит это поле в истории авто.',
}
...
export const CAR_SERVICE_ACCESS_HINT = {
  ...
  noService:
    'Карточка только в вашем гараже: обслуживание у партнёра ещё не привязано. Записи «от сервиса» появятся после заявки на привязку или когда детейлинг заведёт авто на ваш аккаунт.',
  linked:
  ...
  rejected:
    'Заявка на привязку отклонена. Уточните данные и попробуйте снова отправить заявку или свяжитесь с сервисом. Ниже — сведения о сервисе по карточке и дата последнего визита при наличии записей.',
}
