      ...
      return (
        ...
        >
          ...
          <p className="muted small" style={{ marginBottom: 20 }}>
            Откройте консоль браузера (F12 → Console) для подробностей. Частая причина — повреждённые данные в
            хранилище; попробуйте «Сбросить демо-данные» на экране входа или обновите страницу.
          </p>
          <button
            type="button"
            className="btn"
